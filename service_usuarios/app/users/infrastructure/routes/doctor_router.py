...
def get_receptionist_by_id(receptionist_id: int, current_user: Principal = Depends(get_current_user)):
...
@close_db_after(Container)
def get_receptionist_dashboard(receptionist_id: int, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
...
@close_db_after(Container)
def get_doctor_dashboard(doctor_id: int, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
...
@close_db_after(Container)
def get_doctor_by_id(doctor_id: int, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
...
@close_db_after(Container)
def create_receptionist(doctor_id: int, data: ReceptionistCreate, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
...
@close_db_after(Container)
def get_receptionists_by_doctor(doctor_id: int, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
...
@close_db_after(Container)
def search_patients(doctor_id: int, name: Optional[str] = None, last_name: Optional[str] = None, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
...
@close_db_after(Container)
def get_patients_by_doctor(doctor_id: int, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
...
@close_db_after(Container)
def generate_invitation_code(doctor_id: int, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
...
@close_db_after(Container)
def unlink_patient(doctor_id: int, patient_id: int, current_user: Principal = Depends(get_current_user)):
    controller = Container.doctor_controller()
