...
from app.medical_record.domain.ports import IRiskPredictionRepository
from app.medical_record.domain.risk_prediction_entity import RiskPredictionEntity
from app.medical_record.infrastructure.models.risk_prediction_model import RiskPrediction
