...
from app.medical_record.infrastructure.models.medical_record_model import MedicalRecord
from app.medical_record.domain.ports import IMedicalRecordRepository
