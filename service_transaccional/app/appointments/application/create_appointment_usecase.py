...
from app.appointments.domain.specifications import IAppointmentSpecification
...
class CreateAppointmentUseCase:
    def __init__(
        ...
        specifications: Optional[List[IAppointmentSpecification]] = None,
    ):
    ...
    def execute(self, entity: AppointmentEntity) -> AppointmentEntity:
        ...
        violations = [spec.error_message() for spec in self.specifications if not spec.is_satisfied_by(entity)]
        if violations:
