...
from app.medical_record.domain.ports import IDiarySymptomSummaryPort
from app.medical_record.domain.dtos import SymptomSummary
from app.patient_diaries.infrastructure.repositories.diary_symptom_extraction_repository import (
    DiarySymptomExtractionRepository,
)
from app.patient_diaries.domain.symptom_aggregation import aggregate_symptoms
